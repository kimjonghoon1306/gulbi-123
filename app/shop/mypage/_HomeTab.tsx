...
const PROGRAMS = {
  partner: {
    ...
    summary: '온종일팜 상품의 나만의 추천 링크를 만들어 어디서든 공유하는 제휴 프로그램이에요. 특정 플랫폼에 묶이지 않고, 내가 잘하는 채널이 곧 나만의 판매 채널이 됩니다.',
    benefits: [
      ['링크 하나로 시작', '마음에 드는 온종일팜 상품을 골라 내 추천 링크를 바로 만들어요.'],
      ['채널 제약 없이 어디서나', '틱톡·유튜브·인스타그램·블로그·카카오톡·개인 홈페이지 등 링크를 공유할 수 있는 곳이라면 어디든 가능해요.'],
