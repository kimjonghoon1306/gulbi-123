...
const SECTIONS: Section[] = [
  ...
  {
    icon: '🚚', title: '송장 등록 (배송)', color: 'linear-gradient(135deg,#60a5fa,#3b82f6)',
    desc: '택배를 보낼 때 송장번호를 입력하면 손님이 실시간 배송조회를 할 수 있어요.',
    steps: [
      { n: '1', text: '"매출 현황"의 "📋 주문 현황"에서 보낼 주문을 찾으세요.' },
      { n: '2', text: '주문 줄 아래 초록색 "🚚 송장 입력"칸에 택배사를 고르고 송장번호를 입력해요.' },
      { n: '3', text: '"저장"을 누르면 끝! 관리자와 손님 화면에도 자동으로 배송정보가 보여요.' },
    ],
    tip: '주문이 없으면 송장칸도 안 생겨요. 주문이 들어와야 입력칸이 보입니다.',
  },
  {
    icon: '🎟️', title: '쿠폰 발급', color: 'linear-gradient(135deg,#f472b6,#ec4899)',
    desc: '할인 쿠폰을 만들면 손님이 장바구니에서 코드를 입력해 할인받을 수 있어요. (안 만들어도 됩니다)',
    steps: [
      { n: '1', text: '메뉴에서 "🎟️ 쿠폰"을 누르세요.' },
      { n: '2', text: '"+ 쿠폰 발급"을 누르고, 코드를 직접 정하거나 "자동생성"을 눌러요.' },
      { n: '3', text: '할인 방식(정률 % / 정액 원)과 할인 값을 정해요. 예: 10% 또는 5,000원.' },
      { n: '4', text: '최소 주문금액·사용 횟수·만료일은 필요할 때만 넣고, 비우면 제한 없음이에요.' },
      { n: '5', text: '"쿠폰 발급하기"를 누르면 끝. 손님에게 코드를 알려주면 사용할 수 있어요.' },
    ],
    tip: '"사용 중지"로 잠시 멈추거나 다시 켤 수 있어요. 발급한 쿠폰은 내가 만든 것만 보여요.',
  },
  {
