...
export default function RetailPage() {
  ...
  const [form, setForm] = useState({ customer_name: '', contact: '', address: '', note: '', payment_method: '가상계좌', status: '접수', courier_code: '', tracking_number: '' })
  ...
  const saveTrackingInline = async (id: string, courier: string, tracking: string) => {
    ...
    await supabase.from('retail_orders').update(patch).eq('id', id)
